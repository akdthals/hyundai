            ...
            <div className="container">
                ...
                <div className="content">
                    <div className="thanks-box">
                        ...
                        <p>
                            더현대닷컴을 이용하시면서 불만족스러웠던 점을 지적해주시면 서비스 개선에 참고하도록 하겠습니다.
                    ...
                    <div className="survey-box">
                        <input type="checkbox" name="" id="" />상품의 다양성/가격/품질/불만
                        <input type="checkbox" name="" id="" />회원 특혜/쇼핑 혜택의 부족
                        <input type="checkbox" name="" id="" />상품의 선택, 주문 등의 사용이 어려움
                        <input type="checkbox" name="" id="" />사이트의 시스템 및 에러 불만
                        <input type="checkbox" name="" id="" />주문취소/반품/교환/AS불만
                        <input type="checkbox" name="" id="" />자주 이용하지 않음
