    ...
    return (
        <footer id="footer">
            ...
            <div className="container">
                ...
                <div className="row2">
                    <div className='logo'>
                        <a href=""><img src="./img/HSM/footer/footer_logo.png" alt="" /></a>
                    </div>
                    <div className='info'>
                    ...
                    <div className='sns'>
                        <a href=""><img src="./img/HSM/footer/footer-icon.png" alt="" /></a>
                    </div>
                </div>
                <div className="row3">
                    <div className="left">
                        <img src="./img/HSM/footer/footer_row3.png" alt="" />
                        <span>|</span>
                        <img src="./img/HSM/footer/footer_row3_02.png" alt="" />
                        <span>|</span>
                        <img src="./img/HSM/footer/footer_row3_03.png" alt="" />
                        <span>|</span>
                        <img src="./img/HSM/footer/footer_row3_04.png" alt="" />
                    </div>
                    <div className="right">
                        <img src="./img/HSM/footer/footer_row3_left.png" alt="" />
                    </div>
