                            ...
                            <div className="slide-view">
                                <div ref={slideRef} className="slide-wrap">
                                    <div className={`slide slide1${cnt===0?' on':''}`}>
                                        <div className="top-box">
                                            <div className="video-box">
                                                <video loop muted autoPlay src="./CYS/video/intro_sec3_1.mp4"></video>
                                            </div>
                                            <div className="img-box">
                                                <div className="box box1">
                                                    <img src="./CYS/img/intro/thehyundai_intro_sec3_1.jpg" alt="" />
                                                    <span>[제이에스티나] ETER 14K 목걸이 (JJERNQ3BS650R4420)</span>
                                                </div>
                                                <div className="box box1">
                                                    <img src="./CYS/img/intro/thehyundai_intro_sec3_2.jpg" alt="" />
                                    ...
                                    <div className={`slide slide2${cnt===1?' on':''}`}>
                                        <div className="top-box">
                                            <div className="video-box">
                                                <video loop muted autoPlay src="./CYS/video/intro_sec3_2.mp4"></video>
                                            </div>
                                            <div className="img-box">
                                                <div className="box box1">
                                                    <img src="./CYS/img/intro/thehyundai_intro_sec3_3.jpg" alt="" />
                                                    <span>[게스진]MN2K1409 남성 스트라이프 반팔티셔츠</span>
                                                </div>
                                                <div className="box box1">
                                                    <img src="./CYS/img/intro/thehyundai_intro_sec3_4.jpg" alt="" />
                                    ...
                                    <div className={`slide slide3${cnt===2?' on':''}`}>
                                        <div className="top-box">
                                            ...
                                            <div className="img-box">
                                                <div className="box box1">
                                                    <img src="./CYS/img/intro/thehyundai_intro_sec3_5.jpg" alt="" />
                                                    <span>[프레쉬] [5천원 상품권(G)][6월더현대단 독] 로즈 딥 하이드레이션 밸런싱 에멀전 100ml 세트</span>
                                                </div>
                                                <div className="box box1">
                                                    <img src="./CYS/img/intro/thehyundai_intro_sec3_6.jpg" alt="" />
