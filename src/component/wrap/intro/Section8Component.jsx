   ...
   const onClickMake=(e)=>{
    ...
    return (
      <section id="section8">
              ...
              <div className="cover">
                  <div className={`row1${state?' on':''}`}>
                    ...
                    <div className="center-box">
                      <div className="center-box-zoom">
                        <a href="!#">
                          <img src="./img/HSM/intro/team099.jpg" alt="" />
                        </a>
                      </div>
                    </div>
                    <div className="right-box">
                      <div className="right-box-top-img">
                        <div className="right-box-top-zoom">
                          <a href="!#">
                            <img src="./img/HSM/intro/team100.jpg" alt="" />
                          </a>
                        </div>
                      ...
                      <div className="right-box-bottom-img">
                        <div className="right-box-bottom-zoom">
                          <a href="!#">
                            <img src="./img/HSM/intro/team101.jpg" alt="" />
                          </a>
                        </div>
                        <div className="bgCol"></div>
                  ...
                  <div className={`row2${state?'':' on'}`}>
                    ...
                    <div className="center-box">
                      <div className="center-box-zoom">
                        <a href="!#">
                          <img src="./img/HSM/intro/team096.jpg" alt="" />
                        </a>
                      </div>
                    </div>
                    <div className="right-box">
                      <div className="right-box-top-img">
                        <div className="right-box-top-zoom">
                          <a href="!#">
                            <img src="./img/HSM/intro/team097.jpg" alt="" />
                          </a>
                        </div>
                        <div className="bgCol"></div>
                        <div className="right-top-text-box">
                      ...
                      <div className="right-box-bottom-img">
                        <div className="right-box-bottom-zoom">
                          <a href="!#">
                            <img src="./img/HSM/intro/team098.jpg" alt="" />
                          </a>
                        </div>
                        <div className="bgCol"></div>
                        <div className="right-bottom-text-box">
        ...
        <div className="img">
          <img src="./img/HSM/intro/team095.png" alt="" />
        </div>
