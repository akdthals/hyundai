...
export function Section7Slide1Component() {
            ...
            <div className="slide-container">
                <div className="slide-view">
                    <ul ref={slideRef} /* style={{left:`-${cnt * 100}%`}} */ className="slide-wrap">
                        <li className="slide">
                            <a href="!#">
                                <img src="./KHB/img/poliform_slide03.jpg" alt="" />
                            </a>
                        </li>
                        <li className="slide">
                            <a href="!#">
                                <img src="./KHB/img/poliform_slide01.jpg" alt="" />
                            </a>
                        </li>
                        <li className="slide">
                            <a href="!#">
                                <img src="./KHB/img/poliform_slide02.jpg" alt="" />
                            </a>
                        </li>
                        <li className="slide">
                            <a href="!#">
            ...
            <div className="slide-container">
                <div className="slide-view">
                    <ul ref={slideRef} /* style={{left:`-${cnt * 100}%`}} */ className="slide-wrap">
                        <li className="slide">
                            <a href="!#">
                                <img src="./KHB/img/nespresso_slide03.jpg" alt="" />
                            </a>
                        </li>
                        <li className="slide">
                            <a href="!#">
                                <img src="./KHB/img/nespresso_slide01.jfif" alt="" />
                            </a>
                        </li>
                        <li className="slide">
                            <a href="!#">
                                <img src="./KHB/img/nespresso_slide02.jfif" alt="" />
                            </a>
                        </li>
                        <li className="slide">
                            <a href="!#">
