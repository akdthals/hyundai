                                ...
                                <ul ref={slideWrap} className="slide-wrap">
                                    {
                                        sec1slide.map((item, idx)=>{
                                            return (<li key={idx} className={`slide slide${idx} ${item.animationClass}`}><img src={item.img} alt="" /><div className="slide-text"><span>{item.text1}</span><p>{item.text2}</p></div></li>);
                                        })
                                    }
                                </ul>
