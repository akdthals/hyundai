                            ...
                            <div className="middle">
                                <div className={`img-box1 fadeinout${num1===0?' on':''}`}>
                                    <div className="left-img">
                                        <a href="!#">
                                            <img src="./img/KHB/moooi_left.jpg" alt="" />
                                    ...
                                    <div className="right-box">
                                        <div className='logo'>
                                            <img src="./img/KHB/moooi_right.jpg" alt="" />
                                        </div>
                                        <div className='text'>
                                ...
                                <div className="left-img">
                                    <a href="!#">
                                        <img src="./img/KHB/poliform_left.jpg" alt="" />
                                        <div className="bottom-box">
                                            <p>브랜드관 바로가기</p>
                                        </div>
                                    </a>
                                ...
                                <div className="right-box">
                                    <div className='logo'>
                                        <img src="./img/KHB/poliform_right.jpg" alt="" />
                                    </div>
                                    <div className='text'>
                                        <p>이탈리아 럭셔리 가구 브랜드</p>
                                    </div>
                                ...
                                <div className="left-img">
                                    <a href="!#">
                                        <img src="./img/KHB/nespresso_left.jpg" alt="" />
                                        <div className="bottom-box">
                                            <p>브랜드관 바로가기</p>
                                        </div>
                                    </a>
                                ...
                                <div className="right-box">
                                    <div className='logo'>
                                        <img src="./img/KHB/nespresso_right.jpg" alt="" />
                                    </div>
                                    <div className='text'>
