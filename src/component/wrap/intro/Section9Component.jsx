                ...
                <div className="gap">
                    ...
                    <div className="content">
                        <div className="banner-img">
                            <a href="!#">
                                <img src="./KHB/img/clubBeauty.jpeg" alt="" />
                                ...
                                <ul style={{left:`-${100 * cnt}%`}} className="slide-wrap">
                                    <li className={`slide slide1 ${cnt===0?' on':''}`}>
                                        <div className="left-box">
                                            <a href="!#"><img src="./KHB/img/slide01.jpg" alt="" /></a>
                                            <div className="text">
                                                <span>여름의 향기</span>
                                            </div>
                                        </div>
                                        <div className="right-box">
                                            <a href="!#"><img src="./KHB/img/slide02.jpg" alt="" /></a>
                                            <div className="text">
                                                <span>카너 바르셀로나</span>
                                            </div>
                                        </div>
                                    ...
                                    <li className={`slide slide2 ${cnt===1?' on':''}`}>
                                        <div className="left-box">
                                            <a href="!#"><img src="./KHB/img/slide03.jpg" alt="" /></a>
                                            <div className="text">
                                                <span>올여름 제모 홈케어</span>
                                            </div>
                                        </div>
                                        <div className="right-box">
                                            <a href="!#"><img src="./KHB/img/slide04.jpg" alt="" /></a>
                                            <div className="text">
