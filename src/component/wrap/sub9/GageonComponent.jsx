            ...
            <div className="title">
              <div className="top-title">
                <ul>
                  ...
                  <li>
                    <img src="./img/HSM/sub9/sub914.png" alt="" />
                  </li>
                  <li>
                    <h2>
                      리빙/가전
                      <div className="top-title-text-box">
                        <ul>
                          <li>
                            <h5>화장품</h5>
                            <img src="./img/HSM/sub9/sub937.png" alt="" />
                          </li>
                          <li>
                            <h5>명품/잡화</h5>
                            <img src="./img/HSM/sub9/sub937.png" alt="" />
                  ...
                  <li>
                    <a href="!#">
                      <img src="./img/HSM/sub9/icon_down_new.png" alt="" />
                    </a>
                  </li>
                </ul>
              </div>
                ...
                <div className="middle-slide-view">
                  <ul className="middle-slide-wrap">
                    <li className="middle-slide slide5">
                      <a href="!#">
                        <img src="./img/HSM/sub9/sub922.jpg" alt="" />
                      </a>
                    </li>
                    <li className="middle-slide slide1">
                      <a href="!#">
                        <img src="./img/HSM/sub9/sub923.jpg" alt="" />
                      </a>
                    </li>
                    <li className="middle-slide slide2">
                      <a href="!#">
                        <img src="./img/HSM/sub9/sub924.jpg" alt="" />
                      </a>
                    </li>
                    <li className="middle-slide slide3">
                      <a href="!#">
                        <img src="./img/HSM/sub9/sub925.jpg" alt="" />
                      </a>
                    </li>
                    <li className="middle-slide slide4">
                      <a href="!#">
                        <img src="./img/HSM/sub9/sub926.jpg" alt="" />
                      </a>
                    </li>
                    <li className="middle-slide slide5">
                      <a href="!#">
            ...
            <div className="middle2-right">
              <ul>
                ...
                <li>
                  <h2>
                    <a href="!#">
                      <img src="./img/HSM/sub9/sub902.png" alt="" />
                    </a>
                  </h2>
                </li>
              </ul>
              ...
              <div className="middle3-slide-view">
                <ul className="middle3-slide-wrap">
                  <li className="middle3-slide slide1">
                    <a href="!#">
                      <img src="./img/HSM/sub9/sub932.jpg" alt="" />
                    </a>
                  </li>
                  <li className="middle3-slide slide2">
                    <a href="!#">
                      <img src="./img/HSM/sub9/sub933.jpg" alt="" />
                    </a>
                  </li>
                  <li className="middle3-slide slide3">
                    <a href="!#">
                      <img src="./img/HSM/sub9/sub934.jpg" alt="" />
                    </a>
                  </li>
                  <li className="middle3-slide slide4">
                    <a href="!#">
                      <img src="./img/HSM/sub9/sub929.jpg" alt="" />
                    </a>
                  </li>
                  <li className="middle3-slide slide5">
                    <a href="!#">
                      <img src="./img/HSM/sub9/sub930.jpg" alt="" />
                    </a>
                  </li>
                  <li className="middle3-slide slide6">
                    <a href="!#">
                      <img src="./img/HSM/sub9/sub931.jpg" alt="" />
                    </a>
                  </li>
                  <li className="middle3-slide slide1">
                    <a href="!#">
              ...
              <div className="bottom-left-page-btn">
                <ul>
                  <li className="bottom-left-page-btn-box on">
                    <h1>유라</h1>
                    <img src="./img/HSM/sub9/bg_green_arrow.png" alt="" />
                  </li>
                        ...
                        <ul>
                          <li>
                            <div className="bottom-slide-img-box">
                              <a href="!#">
                                <img src="./img/HSM/sub9/sub939.jpg" alt="" />
                              </a>
                            </div>
                      ...
                      <li className="bottom-slide slide14">
                        <ul>
                          <li>
                            <div className="bottom-slide-img-box">
                              <a href="!#">
                                <img src="./img/HSM/sub9/sub942.jpg" alt="" />
                              </a>
                            </div>
                            <div className="bottom-slide-text-box">
                              <div className="up-text-box">
                      ...
                      <li className="bottom-slide slide15">
                        <ul>
                          <li>
                            <div className="bottom-slide-img-box">
                              <a href="!#">
                                <img src="./img/HSM/sub9/sub943.jpg" alt="" />
                              </a>
                            </div>
                            <div className="bottom-slide-text-box">
                              <div className="up-text-box">
                          ...
                          <li className="bottom-slide slide1">
                            <ul>
                              <li>
                                <div className="bottom-slide-img-box">
                                  <a href="!#">
                                    <img src="./img/HSM/sub9/sub944.jpg" alt="" />
                                  </a>
                                </div>
                                <div className="bottom-slide-text-box">
                                  <div className="up-text-box">
                                    <h1>
                                      <strong>6,300,000</strong>원
                                    </h1>
                                    <h3>[LIVE][유라] 전자동 커피머신 Z10</h3>
                                  </div>
                                  <div className="down-text-box">
                                    <h5>현대백화점</h5>
                                    <h4>무 12</h4>
                          ...
                          <li className="bottom-slide slide2">
                            <ul>
                              <li>
                                <div className="bottom-slide-img-box">
                                  <a href="!#">
                                    <img src="./img/HSM/sub9/sub945.jpg" alt="" />
                                  </a>
                                </div>
                                <div className="bottom-slide-text-box">
                                  <div className="up-text-box">
                                    <h1>
                                      <strong>4,390,000</strong>원
                                    </h1>
                                    <h3>[LIVE][유라] 전자동 커피머신 Z10</h3>
                                  </div>
                                  <div className="down-text-box">
                          ...
                          <li className="bottom-slide slide3">
                            <ul>
                              <li>
                                <div className="bottom-slide-img-box">
                                  <a href="!#">
                                    <img src="./img/HSM/sub9/sub946.jpg" alt="" />
                                  </a>
                                </div>
                                <div className="bottom-slide-text-box">
                                  <div className="up-text-box">
                                    <h1>
                                      <strong>3,900,000</strong>원
                                    </h1>
                                    <h3>[LIVE][유라] 전자동 커피머신 Z10</h3>
                                  </div>
                                  <div className="down-text-box">
                      ...
                      <li className="bottom-slide slide4">
                        <ul>
                          <li>
                            <div className="bottom-slide-img-box">
                              <a href="!#">
                                <img src="./img/HSM/sub9/sub947.jpg" alt="" />
                              </a>
                            </div>
                            <div className="bottom-slide-text-box">
                              <div className="up-text-box">
                      ...
                      <li className="bottom-slide slide5">
                        <ul>
                          <li>
                            <div className="bottom-slide-img-box">
                              <a href="!#">
                                <img src="./img/HSM/sub9/sub948.jpg" alt="" />
                              </a>
                            </div>
                            <div className="bottom-slide-text-box">
                              <div className="up-text-box">
                      ...
                      <li className="bottom-slide slide6">
                        <ul>
                          <li>
                            <div className="bottom-slide-img-box">
                              <a href="!#">
                                <img src="./img/HSM/sub9/sub949.jpg" alt="" />
                              </a>
                            </div>
                            <div className="bottom-slide-text-box">
                              <div className="up-text-box">
                                <h1>
                                  <strong>1,100,000</strong>원
                                </h1>
                                <h3>젠하이저 프리미엄 인이어이어폰 IE-600</h3>
                              </div>
                              <div className="down-text-box">
                                <h5>현대백화점5%</h5>
                                <h4>무 12</h4>
                      ...
                      <li className="bottom-slide slide7">
                        <ul>
                          <li>
                            <div className="bottom-slide-img-box">
                              <a href="!#">
                                <img src="./img/HSM/sub9/sub950.jpg" alt="" />
                              </a>
                            </div>
                            <div className="bottom-slide-text-box">
                              <div className="up-text-box">
                                ...
                                <h3>
                                  [23년형]이탈리아 이메텍전기요 프리미엄
                                  전자파안심 순면 더블 IMT-917 (여우)
                                </h3>
                              </div>
                              <div className="down-text-box">
                                <h5>현대백화점5%</h5>
                      ...
                      <li className="bottom-slide slide8">
                        <ul>
                          <li>
                            <div className="bottom-slide-img-box">
                              <a href="!#">
                                <img src="./img/HSM/sub9/sub951.jpg" alt="" />
                              </a>
                            </div>
                            <div className="bottom-slide-text-box">
                              <div className="up-text-box">
                      ...
                      <li className="bottom-slide slide9">
                        <ul>
                          <li>
                            <div className="bottom-slide-img-box">
                              <a href="!#">
                                <img src="./img/HSM/sub9/sub952.jpg" alt="" />
                              </a>
                            </div>
                            <div className="bottom-slide-text-box">
                              <div className="up-text-box">
                      ...
                      <li className="bottom-slide slide10">
                        <ul>
                          <li>
                            <div className="bottom-slide-img-box">
                              <a href="!#">
                                <img src="./img/HSM/sub9/sub953.jpg" alt="" />
                              </a>
                            </div>
                            <div className="bottom-slide-text-box">
                              <div className="up-text-box">
                      ...
                      <li className="bottom-slide slide11">
                        <ul>
                          <li>
                            <div className="bottom-slide-img-box">
                              <a href="!#">
                                <img src="./img/HSM/sub9/sub954.jpg" alt="" />
                              </a>
                            </div>
                            <div className="bottom-slide-text-box">
                              <div className="up-text-box">
                      ...
                      <li className="bottom-slide slide12">
                        <ul>
                          <li>
                            <div className="bottom-slide-img-box">
                              <a href="!#">
                                <img src="./img/HSM/sub9/sub955.jpg" alt="" />
                              </a>
                            </div>
                            <div className="bottom-slide-text-box">
                              <div className="up-text-box">
