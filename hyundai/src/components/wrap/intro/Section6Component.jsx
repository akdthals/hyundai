...
function Section6Component(props) {
    ...
    React.useEffect(()=>{
        ...
        function pageNation(){
            $('.page-btn').removeClass('on');//모든 페이지의 on 클래스 제거하고 
            $('.page-btn').eq(cnt >2 ? 0 : cnt/* nth child와 같은 역할 */).addClass('on');//대신 현재 슬라이드 번호에만 클래스 생성
        }
                                        ...
                                        <li className='slide slide2'>
                                            <ul className="slide-box">
                                                <li>
                                                    <a href="">
                                                        <div className="img-box">
                                                            <img src="./PJH/img/intro/section6_slide4.jpg" alt="" />
                                                        </div>
                                                ...
                                                <li>
                                                    <a href="">
                                                        <div className="img-box">
                                                            <img src="./PJH/img/intro/section6_slide5.jpg" alt="" />
                                                        </div>
                                                        <div className="text-box">
                                                            <h3>라코스테 시즌오프</h3>
                                                        </div>
                                                ...
                                                <li>
                                                    <a href="">
                                                        <div className="img-box">
                                                            <img src="./PJH/img/intro/section6_slide6.jpg" alt="" />
                                                        </div>
                                                        <div className="text-box">
                                                            <h3>써머 하드웨어 컬렉션</h3>
                                                        </div>
                                        ...
                                        <li className='slide slide1'>
                                            <ul className="slide-box">
                                                <li>
                                                    <a href="">
                                                        <div className="img-box">
                                                            <img src="./PJH/img/intro/section6_slide1.jpg" alt="" />
                                                        </div>
                                                        <div className="text-box">
                                                            <h3>울랄라 x 빨간머리앤</h3>
                                                        </div>
                                                ...
                                                <li>
                                                    <a href="">
                                                        <div className="img-box">
                                                            <img src="./PJH/img/intro/section6_slide2.jpg" alt="" />
                                                        </div>
                                                        <div className="text-box">
                                                ...
                                                <li>
                                                    <a href="">
                                                        <div className="img-box">
                                                            <img src="./PJH/img/intro/section6_slide3.jpg" alt="" />
                                                        </div>
                                                        <div className="text-box">
                                                            <h3>ABC마트 여름슈즈 대전</h3>
                                                        </div>
