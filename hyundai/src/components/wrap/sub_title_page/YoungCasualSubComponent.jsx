                                    ...
                                    <div className="slide-view">
                                        <ul className="slide-wrap">
                                            <li className="slide slide1">
                                                <img src="./PJH/img/youngCasual/young_casual_slide1.jpg" alt="" />
                                            </li>
                                            <li className="slide slide2">
                                                <img src="./PJH/img/youngCasual/young_casual_slide2.jpg" alt="" />
                                            </li>
                                            <li className="slide slide3">
                                                <img src="./PJH/img/youngCasual/young_casual_slide3.jpg" alt="" />
                                            </li>
                                            <li className="slide slide4">
                                                <img src="./PJH/img/youngCasual/young_casual_slide4.jpg" alt="" />
                                            </li>
                                            <li className="slide slide5">
                                                <img src="./PJH/img/youngCasual/young_casual_slide5.jpg" alt="" />
                                            </li>
                                            <li className="slide slide1">
                                                <img src="./PJH/img/youngCasual/young_casual_slide1.jpg" alt="" />
                                            </li>
                                        ...
                                        <div className="slide-view">
                                            <ul className="slide-wrap">
                                                ...
                                                <li className='slide'>
                                                    <a href="">
                                                        <div className="img-box">
                                                            <img src="./PJH/img/youngCasual/new arrival1 (0).jpg" alt="" />
                                                        </div>
                                                ...
                                                <li className='slide'>
                                                    <a href="">
                                                        <div className="img-box">
                                                            <img src="./PJH/img/youngCasual/new arrival1 (1).jpg" alt="" />
                                                        </div>
                                                        <div className="text-box">
                                                            <div className="price-info">
                                                ...
                                                <li className='slide'>
                                                    <a href="">
                                                        <div className="img-box">
                                                            <img src="./PJH/img/youngCasual/new arrival1 (2).jpg" alt="" />
                                                        </div>
                                                        <div className="text-box">
                                                            <div className="price-info">
                                                ...
                                                <li className='slide'>
                                                    <a href="">
                                                        <div className="img-box">
                                                            <img src="./PJH/img/youngCasual/new arrival1 (3).jpg" alt="" />
                                                        </div>
                                                        <div className="text-box">
                                                            <div className="price-info">
                                                ...
                                                <li className='slide'>
                                                    <a href="">
                                                        <div className="img-box">
                                                            <img src="./PJH/img/youngCasual/new arrival1 (4).jpg" alt="" />
                                                        </div>
                                                        <div className="text-box">
                                                            <div className="price-info">
                                                ...
                                                <li className='slide'>
                                                    <a href="">
                                                        <div className="img-box">
                                                            <img src="./PJH/img/youngCasual/new arrival1 (5).jpg" alt="" />
                                                        </div>
                                                        <div className="text-box">
                                                            <div className="price-info">
                                                                <span className="discount-price">0원</span>
                                                ...
                                                <li className='slide'>
                                                    <a href="">
                                                        <div className="img-box">
                                                            <img src="./PJH/img/youngCasual/new arrival1 (6).jpg" alt="" />
                                                        </div>
                                                        <div className="text-box">
                                                            <div className="price-info">
                                                ...
                                                <li className='slide'>
                                                    <a href="">
                                                        <div className="img-box">
                                                            <img src="./PJH/img/youngCasual/new arrival1 (7).jpg" alt="" />
                                                        </div>
                                                        <div className="text-box">
                                                            <div className="price-info">
                                                ...
                                                <li className='slide'>
                                                    <a href="">
                                                        <div className="img-box">
                                                            <img src="./PJH/img/youngCasual/new arrival1 (8).jpg" alt="" />
                                                        </div>
                                                        <div className="text-box">
                                                            <div className="price-info">
                                                ...
                                                <li className='slide'>
                                                    <a href="">
                                                        <div className="img-box">
                                                            <img src="./PJH/img/youngCasual/new arrival1 (12).jpg" alt="" />
                                                        </div>
                                                        <div className="text-box">
                                                            <div className="price-info">
                                                                <span className="discount-price">0원</span>
                                                ...
                                                <li className='slide'>
                                                    <a href="">
                                                        <div className="img-box">
                                                            <img src="./PJH/img/youngCasual/new arrival1 (13).jpg" alt="" />
                                                        </div>
                                                        <div className="text-box">
                                                            <div className="price-info">
                                                                <span className="discount-price">0원</span>
                                                ...
                                                <li className='slide'>
                                                    <a href="">
                                                        <div className="img-box">
                                                            <img src="./PJH/img/youngCasual/new arrival1 (14).jpg" alt="" />
                                                        </div>
                                                        <div className="text-box">
                                                            <div className="price-info">
                                                                <span className="discount-price">0원</span>
                                                ...
                                                <li className='slide'>
                                                    <a href="">
                                                        <div className="img-box">
                                                            <img src="./PJH/img/youngCasual/new arrival1 (15).jpg" alt="" />
                                                        </div>
                                                        <div className="text-box">
                                                            <div className="price-info">
                                                ...
                                                <li className='slide'>
                                                    <a href="">
                                                        <div className="img-box">
                                                            <img src="./PJH/img/youngCasual/new arrival1 (16).jpg" alt="" />
                                                        </div>
                                                        <div className="text-box">
                                                            <div className="price-info">
                                                ...
                                                <li className='slide'>
                                                    <a href="">
                                                        <div className="img-box">
                                                            <img src="./PJH/img/youngCasual/new arrival1 (17).jpg" alt="" />
                                                        </div>
                                                        <div className="text-box">
                                                            <div className="price-info">
                                                ...
                                                <li className='slide'>
                                                    <a href="">
                                                        <div className="img-box">
                                                            <img src="./PJH/img/youngCasual/new arrival1 (18).jpg" alt="" />
                                                        </div>
                                                        <div className="text-box">
                                                            <div className="price-info">
                                                ...
                                                <li className='slide'>
                                                    <a href="">
                                                        <div className="img-box">
                                                            <img src="./PJH/img/youngCasual/new arrival1 (19).jpg" alt="" />
                                                        </div>
                                                        <div className="text-box">
                                                            <div className="price-info">
                                                ...
                                                <li className='slide'>
                                                    <a href="">
                                                        <div className="img-box">
                                                            <img src="./PJH/img/youngCasual/new arrival1 (20).jpg" alt="" />
                                                        </div>
                                                        <div className="text-box">
                                                            <div className="price-info">
