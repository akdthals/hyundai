...
function SignUpComponent({timer, timerCounterfn, 회원가입, confirmModalOpen}) {
    ...
    const formData = {
        ...
        "user_hp":          `${state.hp1+state.hp2+state.hp3}`,
            ...
            <div className="container">
                <div className="gap">
                    ...
                    <div className="content">
                        <form onSubmit={onSubmitSignupEvent} name='sign_up_form' id='signUpForm' method='post'>
                                ...
                                <div className="input-box">
                                    <ul>
                                        <li>
                                            ...
                                            <span className={`validation-check ${state.isIdErr ? 'error' : 'ok'}`}></span>
                                        ...
                                        <li>
                                            ...
                                            <span className={`validation-check ${state.isPwError ? 'error' : 'ok'}`}></span>
                                        ...
                                        <li>
                                            ...
                                            <span className={`validation-check ${state.isPw2Error ? 'error' : 'ok'}`}></span>
                                        ...
                                        <li>
                                            ...
                                            <span className={`validation-check ${state.isNameError ? 'error' : 'ok'}`}></span>
                                        ...
                                        <li>    
                                            ...
                                            <span className={`validation-check ${state.isBirthError ? 'error' : 'ok'}`}></span>
                                        ...
                                        <li>
                                            ...
                                            <span className={`validation-check ${state.isHpError ? 'error' : 'ok'}`}></span>
                                            <p className={`error-msg${ state.isHpMsg  ? ' on' : ''}`}>{state.isHpMsg}</p>
                                        </li>
                                        <li>
                                            ...
                                            <span className={`validation-check ${state.isAddr1Error ? 'error' : 'ok'}`}></span>
                                            <p className={`error-msg${ state.isAddr1Msg  ? ' on' : ''}`}>{state.isAddr1Msg}</p>
                                        </li>
                                        <li>
                                            ...
                                            <span className={`validation-check ${state.isAddr2Error ? 'error' : 'ok'}`}></span>
                                            <p className={`error-msg${ state.isAddr2Msg  ? ' on' : ''}`}>{state.isAddr2Msg}</p>
                                        </li>
                                    </ul>
                                </div>
                            </div>
...
SignUpComponent.defaultProps={
    회원가입: {
        ...
        비밀번호확인:'',
        isPwError :true,
        isPwMsg:'비밀번호를 입력해주세요',
        isPw2Error :true,
        isPw2Msg:'비밀번호가 일치하는지 확인해주세요',
        ...
        주소1 :'',
        주소2: '',
        isAddr1Msg: '기본 주소를 입력해주세요',
        isAddr1Error :true,
        isAddr2Msg: '상세 주소를 입력해주세요',
        isAddr2Error :true,
